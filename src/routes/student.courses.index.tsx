...
import { Globe, ArrowRight, Award, Search, BarChart2, CheckCircle, TrendingUp, Building } from "lucide-react";

export const Route = createFileRoute("/student/courses/")({
  component: StudentUniversesPage,
});

function StudentUniversesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Compact & Professional 2x2 Grid of Universe Cards */}
      <div className="grid md:grid-cols-2 gap-5">
        {filteredUniverses.map((u) => (
          ...
          >
            {/* Card Header: Compact & Professional */}
            <div className="space-y-3">
              ...
              {/* Minimal Professional Performers Badges */}
