...
export const Route = createFileRoute("/lab")({
  component: StandaloneLabPage,
});

export function StandaloneLabPage() {
          ...
          <div className="max-w-5xl mx-auto h-full flex flex-col justify-center">
            ...
            {activeMenu !== "guidelines" && currentPage === 2 && (
              <div className="bg-white p-6 sm:p-8 rounded-3xl border border-[#e2e8f0] shadow-sm max-w-md mx-auto my-auto space-y-6 w-full">
                ...
                <button
                  onClick={() => goToPage(3)}
                  className="w-full py-3 bg-[#2563eb] text-[#ffffff] rounded-xl text-xs font-bold hover:bg-blue-700 flex items-center justify-center gap-2 shadow-md transition-all"
                >
            ...
            {activeMenu !== "guidelines" && currentPage === 23 && (
              <div className="space-y-6 my-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-mono">
                  ...
                  <div className="bg-[#ffffff] p-4 rounded-2xl border"><span>RevPAR</span><div className="text-lg font-black text-indigo-600 mt-1">₹{task1Forecast.revPar.toLocaleString("en-IN")}</div></div>
